...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">Compras</h4>
    </div>
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <a href="main?module=add-purchase" class="btn btn-primary btn-icon-text mb-2 mb-md-0 mr-2">
        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTablePurchases" class="table table-stripe table-hover table-bordered">
                        <thead>
                            <tr>
                                <th>id</th>
                                <th>Proveedor</th>
...
<div class="modal fade" id="modalDeletePurchases" tabindex="-1" role="dialog" aria-labelledby="modalDeletePurchases"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="formDeletePurchases">
